  ...
  renderLocationContainer() {
    return (
      <View style={styles.location_container}>
        ...
        <Text style={styles.location_subtext}>
          ...
          <View style={styles.show_me_settings_container}>
            <View style={styles.show_me_row_container}>
              ...
              <Switch
                ...
                thumbTintColor={
                  this.state.male ? 'rgb(229,74,80)' : 'rgb(232,232,232)'
                }
              />
            </View>
            <View style={styles.show_me_row_container}>
              ...
              <Switch
                ...
                onTintColor={'rgb(247,196,198)'}
                thumbTintColor={
                  this.state.female ? 'rgb(229,74,80)' : 'rgb(232,232,232)'
                }
              />
            </View>
          </View>
  ...
  render() {
    return (
      <View style={styles.container}>
        <Collapsable>
          {/* renderHeader=
          {<Header title={'Settings'} leftButton={() => this.popToScreen()} />} */}
